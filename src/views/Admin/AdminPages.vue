            ...
            <b-card no-body>
                <b-tabs card>
                    <b-tab title="Produtos" active>
                     ...
                     <b-tab title="Fornecedores" active>
                        <FornecAdmin />
                    </b-tab>
                     <b-tab title="Categorias" active>
                        <CategoryAdmin />
                    </b-tab>
                    <b-tab title="Entrada Produtos" active>
                        <EstoqueAdmin />
                    </b-tab>
                    <b-tab title="Saidas Produtos" active>
                        <SaidaMercAdmin />
                    </b-tab>
...
import SaidaMercAdmin from './SaidaMercAdmin'
...
export default {
  name: 'AdminPages',
  components: { PageTitle, CategoryAdmin, FornecAdmin, ProdutoAdmin, ConsultaAdmin, EstoqueAdmin, SaidaMercAdmin }
